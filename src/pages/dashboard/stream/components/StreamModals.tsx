          ...
          >
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-[9px] font-black uppercase tracking-[0.16em] text-zinc-500 sm:text-[10px] sm:tracking-[0.2em]">
                Support the live host instantly.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative mt-3">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-black/40 py-4 pl-11 pr-5 font-black text-white focus:border-brand-primary/50 focus:outline-none"
                    required
                  />
                </div>
              </div>
